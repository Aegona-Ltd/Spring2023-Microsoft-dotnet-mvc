namespace ProductManagament.Migrations
{
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ProductManagament.Models.ProductDBContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "ProductManagament.Models.ProductDBContext";
        }

        protected override void Seed(ProductManagament.Models.ProductDBContext context)
        {
