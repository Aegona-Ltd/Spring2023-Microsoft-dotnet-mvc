...
namespace ContosoUniversity.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? DepartmentID, byte[] rowVersion)
        {
            ...
            var departmentToUpdate = await _context.Departments.Include(i => i.Administrator).FirstOrDefaultAsync(m => m.DepartmentID == DepartmentID);
